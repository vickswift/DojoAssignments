...
# maximum value in the array. Your program should also work with a given array that
# has all negative numbers (e.g. [-3, -5, -7]), or even a mix of positive numbers,
...
# other complicated cases. You can use a length function with this assignment.
...
# between 1 to 255. When the program is done, 'y' should have the
# value of [1, 3, 5, 7, ... 255].
...
# array whose value is greater than a given value y. For example,
# if array = [1, 3, 5, 7] and y = 3, after your program is run it will print 2
...
# negative number with the value of 0. When the program is done, x should have no
...
# with the maximum number in the array, the minimum value in the array, and
...
# with the string 'Dojo'. For example, if array x is initially [-1, -3, 2] after
# your program is done that array should be ['Dojo', 'Dojo', 2].
